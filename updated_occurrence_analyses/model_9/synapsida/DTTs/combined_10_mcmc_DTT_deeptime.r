...
# Add mass extinction lines
  ...
  labs(
    title = "Synapsida Model 9 Diversity Trajectory", ####### SET MODEL/CLADE TITLE
    x = "Time (Ma)",
...
###### CHANGE PDF PATH
ggsave('C:\\Users\\SimoesLabAdmin\\Documents\\pt_diversity_rates\\updated_occurrence_analyses\\model_9\\synapsida\\DTTs\\combined_10_mcmc_DTT_deeptime.pdf', plot = plot, width = 8, height = 8, units = "in")