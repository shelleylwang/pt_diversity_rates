...
p1 <- create_plot_with_geo(L_data$poly_data, L_data$mean_data, "#4c4cec", 
                         "Terrestrial Reptilia Model 9: BDNN MCMC by 1Myr with BRIDGE and Stage Predictorss", 
...
pdf(file = "C:\\Users\\SimoesLabAdmin\\Documents\\pt_diversity_rates\\updated_occurrence_analyses\\model_9\\reptilia_terr\\RTTs\\combined_10_RTT_deeptime_autoscaled.pdf", 
    width = 8, height = 12)
