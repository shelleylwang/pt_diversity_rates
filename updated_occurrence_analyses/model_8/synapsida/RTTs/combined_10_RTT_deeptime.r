...
p1 <- create_plot_with_geo(L_data$poly_data, L_data$mean_data, "#4c4cec", 
                         "Synapsida Model 8: BDNN MCMC by 1Myr with Isotopic and Stage Predictors", 
...
pdf(file = "C:\\Users\\SimoesLabAdmin\\Documents\\pt_diversity_rates\\updated_occurrence_analyses\\model_8\\synapsida\\RTTs\\combined_10_RTT_deeptime_autoscaled.pdf", 
    width = 8, height = 12)
