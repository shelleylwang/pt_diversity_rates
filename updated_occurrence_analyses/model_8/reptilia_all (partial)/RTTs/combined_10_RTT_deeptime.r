...
rtt_text <- readLines("C:\\Users\\SimoesLabAdmin\\Documents\\pt_diversity_rates\\updated_occurrence_analyses\\model_8\\reptilia_all\\RTTs\\combined_10_RTT.r", warn = FALSE)
...
p1 <- create_plot_with_geo(L_data$poly_data, L_data$mean_data, "#4c4cec", 
                         "All Reptilia Model 8: BDNN MCMC by 1Myr with Isotopic and Stage Predictors", 
...
pdf(file = "C:\\Users\\SimoesLabAdmin\\Documents\\pt_diversity_rates\\updated_occurrence_analyses\\model_8\\reptilia_all\\RTTs\\combined_10_RTT_deeptime_autoscaled.pdf", 
    width = 8, height = 12)
