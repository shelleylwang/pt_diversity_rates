#!/bin/bash
#SBATCH --job-name=model_A_rep_terr         # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/model_A_rep_terr_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/model_A_rep_terr_%j_%A_%a.err
...
python ../PyRate/PyRate.py updated_occurrence_analyses/data/Perm-Trias/pt_reptilia_terr_pyrate_input_txt_PyRate.py \
 ...
 -edgeShift 274.4 237 \
 -out _model_A -wd updated_occurrence_analyses/model_A/reptilia_terr -n 200000000 -s 10000 -j ${SLURM_ARRAY_TASK_ID}
