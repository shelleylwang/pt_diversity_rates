#!/bin/bash
#SBATCH --job-name=model_D_rep_terr_200          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/model_D_rep_terr_200_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/model_D_rep_terr_200_%j_%A_%a.err
...
python ../PyRate/PyRate.py updated_occurrence_analyses/data/Perm-Trias/pt_reptilia_terr_pyrate_input_txt_PyRate.py \
 ...
 -n 200000000 -s 10000 -wd updated_occurrence_analyses/model_D/reptilia_terr -out _model_D_200 \
 -tuneT 0.1 100 -j ${SLURM_ARRAY_TASK_ID} 