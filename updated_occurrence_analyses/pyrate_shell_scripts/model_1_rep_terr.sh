#!/bin/bash
#SBATCH --job-name=model_1_rep_terr          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/model_1_rep_terr_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/model_1_rep_terr_%j_%A_%a.err
