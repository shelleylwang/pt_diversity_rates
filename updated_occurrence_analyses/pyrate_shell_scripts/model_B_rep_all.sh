#!/bin/bash
#SBATCH --job-name=model_B_rep          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/model_B_rep_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/model_B_rep_%j_%A_%a.err
...
python ../PyRate/PyRate.py updated_occurrence_analyses/data/Perm-Trias/pt_reptilia_all_pyrate_input_txt_PyRate.py \
 ...
 -edgeShift 274.4 237 \
 -out _model_B -wd updated_occurrence_analyses/model_B/reptilia_all -n 200000000 -s 10000 -j ${SLURM_ARRAY_TASK_ID} 
