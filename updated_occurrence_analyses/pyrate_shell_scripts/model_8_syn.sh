#!/bin/bash
#SBATCH --job-name=model_8_syn          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/model_8_syn_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/model_8_syn_%j_%A_%a.err
