#!/bin/bash
#SBATCH --job-name=model_8_syn_new_pyrate_inter          # Job name
...
#SBATCH --output=/workdir/pt_diversity_rates/err_out/model_8_syn_new_pyrate_inter_%j_%A_%a.out
#SBATCH --error=/workdir/pt_diversity_rates/err_out/model_8_syn_new_inter_%j_%A_%a.err
...
python ../PyRate/PyRate.py updated_occurrence_analyses/data/Perm-Trias/pt_synapsida_pyrate_input_txt_PyRate.py  \
 ...
 -BDNNtimetrait 0 -translate -175 -out _model_8_new_pyrate_inter -wd updated_occurrence_analyses/model_8/synapsida_new_pyrate_inter -n 200000000 -s 1000 -j ${SLURM_ARRAY_TASK_ID} 
