#!/bin/bash
#SBATCH --job-name=model_7_1myr_iso_rep_all          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/model_7_1myr_iso_rep_all_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/model_7_1myr_iso_rep_all_%j_%A_%a.err
...
python ../PyRate/PyRate.py updated_occurrence_analyses/data/Perm-Trias/pt_reptilia_all_pyrate_input_txt_PyRate.py \
 ...
 -out _model_7_1myr_iso -wd updated_occurrence_analyses/model_7/isotopic_pt_1myr/reptilia_all -n 200000000 -s 10000 -j ${SLURM_ARRAY_TASK_ID} 
