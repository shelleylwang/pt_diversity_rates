#!/bin/bash
#SBATCH --job-name=model_7_syn          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/model_7_syn_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/model_7_syn_%j_%A_%a.err
...
python ../PyRate/PyRate.py updated_occurrence_analyses/data/Perm-Trias/pt_synapsida_pyrate_input_txt_PyRate.py \
 ...
 -out _model_7 -wd updated_occurrence_analyses/model_7/synapsida -n 200000000 -s 10000 -j ${SLURM_ARRAY_TASK_ID} 
