#!/bin/bash
#SBATCH --job-name=model_2_syn_200          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/model_2_syn_200_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/model_2_syn_200_%j_%A_%a.err
...
python ../PyRate/PyRate.py updated_occurrence_analyses/data/Perm-Trias/pt_synapsida_pyrate_input_txt_PyRate.py \
 ...
 -n 200000000 -s 10000 -wd updated_occurrence_analyses/model_2_and_5/synapsida -out _model_2_200 -j ${SLURM_ARRAY_TASK_ID} 