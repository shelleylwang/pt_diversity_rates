#!/bin/bash
#SBATCH --job-name=model_2_syn_200_s1k          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/model_2_syn_200_s1k_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/model_2_syn_200_s1k_%j_%A_%a.err
