#!/bin/bash
#SBATCH --job-name=model_9_syn_new_dates         # Job name
...
#SBATCH --output=/workdir/pt_diversity_rates/err_out/model_9_syn_new_dates_%j_%A_%a.out
#SBATCH --error=/workdir/pt_diversity_rates/err_out/model_9_syn_new_dates_%j_%A_%a.err
...
python ../PyRate/PyRate.py updated_occurrence_analyses/data/Perm-Trias/pt_synapsida_pyrate_input_txt_PyRate.py  \
 ...
 -BDNNtimevar updated_occurrence_analyses/data/AF_climatic_data/BRIDGE_and_binary_stages_data_new_dates/synapsida_BRIDGE_stages_timevar_1myr_new_dates.txt \
