...
ltt_text <- readLines("C:\\Users\\SimoesLabAdmin\\Documents\\pt_diversity_rates\\updated_occurrence_analyses\\model_2_and_5\\200_its_s1k\\synapsida\\combined_10_mcmc_LTT.r", warn = FALSE) 
...
rtt_text <- readLines("C:/Users/SimoesLabAdmin/Documents/pt_diversity_rates/updated_occurrence_analyses/model_2_and_5/200_its_s1k/synapsida/RTT_plots.r", warn = FALSE)
...
p1 <- create_plot_with_geo(L_data$poly_data, L_data$mean_data, "#4c4cec", 
                         "Synapsida Models 2 & 5: RJMCMC by 1Myr with No Predictors", 
...
combined_plots
ggsave(plot = combined_plots, "C:/Users/SimoesLabAdmin/Documents/pt_diversity_rates/updated_occurrence_analyses/model_2_and_5/200_its_s1k/synapsida/Plot_Syn_DTT_RTT.pdf", width = 8, height = 14)
