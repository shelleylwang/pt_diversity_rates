...
ltt_text <- readLines("C:/Users/SimoesLabAdmin/Documents/pt_diversity_rates/updated_occurrence_analyses/model_9/reptilia_terr_offset/DTTs/combined_10_mcmc_LTT.r", warn = FALSE) 
...
rtt_text <- readLines("C:/Users/SimoesLabAdmin/Documents/pt_diversity_rates/updated_occurrence_analyses/model_9/reptilia_terr_offset/RTTs/combined_10_RTT.r", warn = FALSE)
...
p1 <- create_plot_with_geo(L_data$poly_data, L_data$mean_data, "#4c4cec", 
                         "Terrestrial Reptilia Model 9: BDNN MCMC by 1Myr with 1Myr BRIDGE Predictors", 
...
combined_plots
ggsave(plot = combined_plots, "C:/Users/SimoesLabAdmin/Documents/pt_diversity_rates/updated_occurrence_analyses/model_9/reptilia_terr_offset/Plot_Syn_DTT_RTT.pdf", width = 8, height = 14)
