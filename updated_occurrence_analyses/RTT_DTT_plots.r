...
ltt_text <- readLines("C:\\Users\\SimoesLabAdmin\\Documents\\pt_diversity_rates\\updated_occurrence_analyses\\model_9\\synapsida_offset_della\\DTTs\\combined_10_mcmc_LTT.r", warn = FALSE) 
...
rtt_text <- readLines("C:/Users/SimoesLabAdmin/Documents/pt_diversity_rates/updated_occurrence_analyses/model_9/synapsida_offset_della/RTTs/combined_10_RTT.r", warn = FALSE)
...
p1 <- create_plot_with_geo(L_data$poly_data, L_data$mean_data, "#4c4cec", 
                         "Synapsida Model 9: BDNN MCMC by 1Myr with 1Myr BRIDGE Predictors", 
...
combined_plots
ggsave(plot = combined_plots, "C:/Users/SimoesLabAdmin/Documents/pt_diversity_rates/updated_occurrence_analyses/model_9/synapsida_offset_della/Plot_Syn_DTT_RTT_2.pdf", width = 8, height = 14)
