...
ltt_text <- readLines('/Volumes/My Passport/pt_diversity_rates/updated_occurrence_analyses/model_3/synapsida/combined_10_mcmc_LTT.r', warn = FALSE) 
...
# Add mass extinction lines
  ...
  labs(
    title = "TEST", ####### SET MODEL/CLADE TITLE
    x = "Time (Ma)",
...
###### CHANGE PDF PATH
ggsave('/Volumes/My Passport/pt_diversity_rates/updated_occurrence_analyses/model_3/synapsida/combined_10_mcmc_DTT_deeptime_test.pdf', plot = plot, width = 8, height = 8, units = "in")