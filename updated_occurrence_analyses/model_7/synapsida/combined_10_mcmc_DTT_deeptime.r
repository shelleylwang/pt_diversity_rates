...
ltt_text <- readLines('/Volumes/My Passport/pt_diversity_rates/updated_occurrence_analyses/model_7/synapsida/combined_10_mcmc_LTT.r', warn = FALSE) 
...
###### CHANGE PDF PATH
ggsave('/Volumes/My Passport/pt_diversity_rates/updated_occurrence_analyses/model_7/synapsida/combined_10_mcmc_DTT_deeptime.pdf', plot = plot, width = 8, height = 8, units = "in")