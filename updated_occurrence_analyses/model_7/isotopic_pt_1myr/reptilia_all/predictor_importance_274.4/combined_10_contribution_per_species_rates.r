pdf(file='C:/Users/SimoesLabAdmin/Documents/pt_diversity_rates/updated_occurrence_analyses/model_7/isotopic_pt_1myr/reptilia_all/combined_10_contribution_per_species_rates.pdf', width = 7, height = 6, useDingbats = FALSE, pointsize = 7)
...
consrank=c(1.0, 0.0,1.0,2.0,4.0,3.0)
consrank2 = order(consrank, decreasing = FALSE)
consrank = order(consrank, decreasing = TRUE)
shap_list = list()
shap_list[[1]]=c(0.3806151960790157, 0.3236322330917375,0.3236322330917375,-0.34059104599265483)
shap_list[[2]]=c(1.1681988913193344, -0.8687062646110375,-0.8687062646110375,0.7722175697579571)
shap_list[[3]]=c(-2.1140875127911567, 0.2070264295492727,0.2070264295492727,0.16009920083843773)
shap_list[[4]]=c(0.40505616194539473, 0.35511793351693516,0.35511793351693516,-0.534110702276881)
shap_list[[5]]=c(0.059582474124617875, 0.050586102400896546,0.050586102400896546,0.0404499250706223)
shap_list[[6]]=c(0.05958247588947416, 0.05058609737602069,0.05058609737602069,0.04044993858689222)
shap = do.call('cbind', shap_list)
baseline = 0.2194147361256182
rate=c(0.35710984506615207, 0.5236737728060689,0.5236737728060689,0.667414518808946)
rate_lwr=c(0.09803125634789467, 0.1443585827946663,0.1443585827946663,0.024143729358911514)
rate_upr=c(0.7376378029584885, 0.9947687089443207,0.9947687089443207,1.6560394018888474)
...
tmp_states = c()
tmp[[1]]=c(-0.3368251919746399, -0.3368251919746399,-0.3368251919746399,-0.15131919085979462)
tmp_states = c(tmp_states, 'lat_range_z_trans')
tmp[[8]]=c(-0.3368251919746399, -0.3368251919746399,-0.3368251919746399,-0.15131919085979462)
tmp_states = c(tmp_states, 'lat_range_z_trans')
...
tmp = vector(mode = 'list', length = 2)
tmp_states = c()
tmp[[2]]=c(0.0, 1.0,1.0,0.0)
tmp_states = c(tmp_states, 'Temperate_N')
tmp[[9]]=c(0.0, 1.0,1.0,0.0)
tmp_states = c(tmp_states, 'Temperate_N')
tmp = do.call('rbind', tmp)
feat[[2]] = tmp[, ord]
...
tmp = vector(mode = 'list', length = 2)
tmp_states = c()
tmp[[3]]=c(1.0, 0.0,0.0,0.0)
tmp_states = c(tmp_states, 'Tropical')
tmp[[10]]=c(1.0, 0.0,0.0,0.0)
tmp_states = c(tmp_states, 'Tropical')
tmp = do.call('rbind', tmp)
feat[[3]] = tmp[, ord]
...
tmp = vector(mode = 'list', length = 2)
tmp_states = c()
tmp[[4]]=c(0.0, 0.0,0.0,1.0)
tmp_states = c(tmp_states, 'Temperate_S')
tmp[[11]]=c(0.0, 0.0,0.0,1.0)
tmp_states = c(tmp_states, 'Temperate_S')
tmp = do.call('rbind', tmp)
feat[[4]] = tmp[, ord]
...
tmp = vector(mode = 'list', length = 2)
tmp_states = c()
tmp[[7]]=c(269.04533081862024, 269.04533081862024,269.04533081862024,269.04533081862024)
tmp_states = c(tmp_states, 'time')
tmp[[14]]=c(269.04533081862024, 269.04533081862024,269.04533081862024,269.04533081862024)
tmp_states = c(tmp_states, 'time')
tmp = do.call('rbind', tmp)
feat[[6]] = tmp[, ord]
...
consrank=c(2.0, 0.0,1.0,3.0,5.0,4.0)
consrank2 = order(consrank, decreasing = FALSE)
consrank = order(consrank, decreasing = TRUE)
shap_list = list()
shap_list[[1]]=c(0.06434424794494308, 0.047421719174106834,0.06434424794494308,0.027394548057959683)
shap_list[[2]]=c(-0.2225530636069638, 0.1892414797322241,-0.2225530636069638,0.10277133323740789)
shap_list[[3]]=c(0.16786496687673647, -0.1973720874991979,0.16786496687673647,0.06489451415238537)
shap_list[[4]]=c(0.05310750527808739, 0.037337866801275724,0.05310750527808739,-0.10245846112247949)
shap_list[[5]]=c(0.010640349700244415, 0.007174019847814635,0.010640349700244415,0.0031807802351297544)
shap_list[[6]]=c(0.010640350553293926, 0.007174018394977642,0.010640350553293926,0.0031807811161676074)
shap = do.call('cbind', shap_list)
baseline = 0.10532505614683033
rate=c(0.34461042686132715, 0.45256404850166293,0.34461042686132715,0.8210452172299847)
rate_lwr=c(0.048879326321184635, 0.13016674667596817,0.048879326321184635,0.07716581597924232)
rate_upr=c(0.6761872619390488, 0.8462851382791996,0.6761872619390488,1.8272758275270462)
rates = cbind(rate, rate_lwr, rate_upr)
species_names = c()
species_names = c(species_names, 'Gecatogomphius')
species_names = c(species_names, 'Kahneria')
species_names = c(species_names, 'Lanthanolania')
...
tmp = vector(mode = 'list', length = 2)
tmp_states = c()
tmp[[1]]=c(-0.3368251919746399, -0.3368251919746399,-0.3368251919746399,-0.3368251919746399)
tmp_states = c(tmp_states, 'lat_range_z_trans')
tmp[[8]]=c(-0.3368251919746399, -0.3368251919746399,-0.3368251919746399,-0.3368251919746399)
tmp_states = c(tmp_states, 'lat_range_z_trans')
tmp = do.call('rbind', tmp)
feat[[1]] = tmp[, ord]
feat_states[[1]] = tmp_states
...
tmp = vector(mode = 'list', length = 2)
tmp_states = c()
tmp[[3]]=c(0.0, 1.0,0.0,0.0)
tmp_states = c(tmp_states, 'Tropical')
tmp[[10]]=c(0.0, 1.0,0.0,0.0)
tmp_states = c(tmp_states, 'Tropical')
tmp = do.call('rbind', tmp)
feat[[3]] = tmp[, ord]
feat_states[[3]] = tmp_states
