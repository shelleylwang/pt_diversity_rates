...
ltt_text <- readLines("C:\\Users\\SimoesLabAdmin\\Documents\\pt_diversity_rates\\updated_occurrence_analyses\\model_7\\isotopic_gl_stages\\synapsida\\combined_10_mcmc_LTT.r", warn = FALSE) 
...
# Add mass extinction lines
  ...
  labs(
    title = "Synapsida Model 7 Diversity Trajectory", ####### SET MODEL/CLADE TITLE
    x = "Time (Ma)",
...
###### CHANGE PDF PATH
ggsave("C:\\Users\\SimoesLabAdmin\\Documents\\pt_diversity_rates\\updated_occurrence_analyses\\model_7\\isotopic_gl_stages\\synapsida\\combined_10_mcmc_DTT_deeptime.pdf", plot = plot, width = 8, height = 8, units = "in")