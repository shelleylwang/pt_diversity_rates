...
rtt_text <- readLines("C:\\Users\\SimoesLabAdmin\\Documents\\pt_diversity_rates\\updated_occurrence_analyses\\model_7\\isotopic_gl_stages\\synapsida\\combined_10_RTT.r", warn = FALSE)
...
p1 <- create_plot_with_geo(L_data$poly_data, L_data$mean_data, "#4c4cec", 
                         "Synapsida Model 7: BDNN MCMC by Stages with Isotopic Predictors by G-L Stages", 
...
pdf(file = "C:\\Users\\SimoesLabAdmin\\Documents\\pt_diversity_rates\\updated_occurrence_analyses\\model_7\\isotopic_gl_stages\\synapsida\\combined_10_RTT_deeptime.pdf", 
    width = 8, height = 12)
