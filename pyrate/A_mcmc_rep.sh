#!/bin/bash
#SBATCH --job-name=A_mcmc_rep          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/A_mcmc_rep_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/A_mcmc_rep_%j_%A_%a.err
...
-wd ./reptilia/mcmc_no_predictors -thread 2 0 -out _A_mcmc -j ${SLURM_ARRAY_TASK_ID} 
