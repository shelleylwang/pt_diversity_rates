...
python ../PyRate/PyRate_thread.py ./data/reptilia_processed_data/reptilia_pyrate_PyRate.py \
...
-wd ./reptilia/mcmc_no_predictors/A_bdnn_update/A_bdnn_update_restored_logs/ -out _A_update_restored