#!/bin/bash
#SBATCH --job-name=bdnn_tem_fixshift_preds          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/bdnn_tem_fixshift_preds_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/bdnn_tem_fixshift_preds_%j_%A_%a.err
...
commands=(
    "python ../PyRate/PyRate.py ./data/temnospondyli_processed_data/temnospondyli_pyrate_PyRate.py -BDNNmodel 1 -fixShift ./data/Time_bins_ByStages.txt -qShift ./data/Time_bins_ByStages.txt -mG -translate 175.0 -n 100000000 -s 10000 -p 2000 -wd ./temnospondyli/ -trait_file ./data/temnospondyli_processed_data/temnospondyli_bdnn_trait_file.txt -BDNNtimevar ./data/env_vars.txt -thread 6 0 -j 1"
