#!/bin/bash
#SBATCH --job-name=A_mcmc_syn          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/A_mcmc_syn_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/A_mcmc_syn_%j_%A_%a.err
...
-wd ./synapsida/mcmc_no_predictors -out _A_mcmc -j ${SLURM_ARRAY_TASK_ID} 
