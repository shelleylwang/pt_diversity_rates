#!/bin/bash
#SBATCH --job-name=D_mcmc_tem          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/D_mcmc_tem_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/D_mcmc_tem_%j_%A_%a.err
...
-wd ./temnospondyli/mcmc_fixshift_no_predictors -thread 2 0 -out _D_mcmc -j ${SLURM_ARRAY_TASK_ID} 