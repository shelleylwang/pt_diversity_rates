#!/bin/bash
#SBATCH --job-name=D_mcmc_rep          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/D_mcmc_rep_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/D_mcmc_rep_%j_%A_%a.err
...
python ../PyRate/PyRate.py ./data/reptilia_processed_data/reptilia_pyrate_PyRate.py -A 0 \
-fixShift ./data/Time_bins_ByStages.txt -qShift ./data/Time_bins_ByStages.txt -mG -n 200000000 -s 20000 -p 2000 \
-wd ./reptilia/mcmc_fixshift_no_predictors -thread 2 0 -out _D_mcmc -j ${SLURM_ARRAY_TASK_ID} 