#!/bin/bash
#SBATCH --job-name=B_bdnn_tem_stdscaled_log_restored         # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/B_bdnn_tem_stdscaled_log_restored_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/B_bdnn_tem_stdscaled_log_restored_%j_%A_%a.err
...
-restore_mcmc ./temnospondyli/mcmc_predictors/B_bdnn_stdscaled_log/temnospondyli_pyrate_${SLURM_ARRAY_TASK_ID}_B_stdscaled_log_G_BDS_BDNN_16_8TVc_mcmc.log \
...
-wd ./temnospondyli/mcmc_predictors/B_bdnn_stdscaled_log/ -out _B_stdscaled_log_restored -j ${SLURM_ARRAY_TASK_ID}
