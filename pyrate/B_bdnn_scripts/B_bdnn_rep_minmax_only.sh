#!/bin/bash
#SBATCH --job-name=B_bdnn_rep_minmax_only         # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/B_bdnn_rep_minmax_only_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/B_bdnn_rep_minmax_only_%j_%A_%a.err
...
-trait_file ./data/reptilia_processed_data/reptilia_bdnn_trait_file.txt -BDNNtimevar ./data/1myr_temp_data/1myr_temp_minmax_only.txt \
-n 100000000 -s 10000 -p 2000 -thread 2 0 -seed 42 \
-wd ./reptilia/ -out _B_minmax_only -j ${SLURM_ARRAY_TASK_ID}
