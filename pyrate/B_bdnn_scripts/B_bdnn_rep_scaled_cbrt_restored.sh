#!/bin/bash
#SBATCH --job-name=B_bdnn_rep_stdscaled_cbrt_restored         # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/B_bdnn_rep_stdscaled_cbrt_restored_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/B_bdnn_rep_stdscaled_cbrt_restored_%j_%A_%a.err
...
-wd ./reptilia/mcmc_predictors/B_bdnn_stdscaled_cbrt/ -out _B_stdscaled_cbrt_restored -j ${SLURM_ARRAY_TASK_ID}
