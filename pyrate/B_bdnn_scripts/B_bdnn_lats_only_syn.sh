#!/bin/bash
#SBATCH --job-name=B_bdnn_lats_only_syn         # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/B_bdnn_lats_only_syn_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/B_bdnn_lats_only_syn_%j_%A_%a.err
...
-trait_file ./data/synapsida_processed_data/synapsida_bdnn_trait_file.txt \
-n 100000000 -s 10000 -p 2000 -BDNNnodes 4 2 -seed 42 \
-wd ./synapsida/ -out _B_lats_only -j ${SLURM_ARRAY_TASK_ID}
