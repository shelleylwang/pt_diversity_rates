#!/bin/bash
#SBATCH --job-name=B_bdnn_rep_stdscaled_only_4_2_update         # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/B_bdnn_rep_stdscaled_only_4_2_update_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/B_bdnn_rep_stdscaled_only_4_2_update_%j_%A_%a.err
...
-n 100000000 -s 10000 -p 2000 -seed 42 -BDNNnodes 4 2 -BDNNupdate_f 0.3 \
