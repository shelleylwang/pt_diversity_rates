#!/bin/bash
#SBATCH --job-name=B_bdnn_rep_stdscaled_boxcox         # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/B_bdnn_rep_stdscaled_boxcox_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/B_bdnn_rep_stdscaled_boxcox_%j_%A_%a.err
...
-wd ./reptilia/ -out _B_stdscaled_boxcox -j ${SLURM_ARRAY_TASK_ID}
