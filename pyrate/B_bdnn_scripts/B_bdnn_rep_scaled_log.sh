#!/bin/bash
#SBATCH --job-name=B_bdnn_rep_stdscaled_log         # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/B_bdnn_rep_stdscaled_log_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/B_bdnn_rep_stdscaled_log_%j_%A_%a.err
...
-wd ./reptilia/ -out _B_stdscaled_log -j ${SLURM_ARRAY_TASK_ID}
