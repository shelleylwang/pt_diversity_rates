#!/bin/bash
#SBATCH --job-name=B_bdnn_rep_stdscaled_cbrt         # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/B_bdnn_rep_stdscaled_cbrt_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/B_bdnn_rep_stdscaled_cbrt_%j_%A_%a.err
