#!/bin/bash
#SBATCH --job-name=C_bdnn_rep_minmax_boxcox_restored # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/C_bdnn_rep_minmax_boxcox_restored_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/C_bdnn_rep_minmax_boxcox_restored_%j_%A_%a.err
...
-translate -175.0 -n 100000000 -s 10000 -p 2000 -wd ./reptilia/mcmc_fixshift_predictors/C_bdnn_minmax_boxcox/ -seed 42 -thread 2 0 -out _C_minmax_boxcox_restored -j ${SLURM_ARRAY_TASK_ID}
