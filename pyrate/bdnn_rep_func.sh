#!/bin/bash
#SBATCH --job-name=BDNN_rep_nopreds_funct       # create a short name for your job
...
#SBATCH --output=/scratch/gpfs/sw8569/bdnn_nopreds_func_%j.out
#SBATCH --error=/scratch/gpfs/sw8569/bdnn_nopreds_funct_%j.err
