#!/bin/bash
#SBATCH --job-name=covar_RJMCMC_rep_TEST          # Job name
...
#SBATCH --time=0-01:00:00               # Time limit, e.g., 1 day and 1 hour
#SBATCH --mail-type=begin               # Send email when job begins
#SBATCH --mail-type=end                 # Send email when job ends
#SBATCH --mail-user=sw8569@princeton.edu
#SBATCH --output=/scratch/gpfs/sw8569/covar_rjmcmc_rep_TEST_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/covar_rjmcmc_rep_%j_TEST_%A_%a.err
