#!/bin/bash
#SBATCH --job-name=D_bdnn_syn_update         # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/D_bdnn_syn_update_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/D_bdnn_syn_update_%j_%A_%a.err
...
-wd ./synapsida/ -out _D_update -j ${SLURM_ARRAY_TASK_ID}
