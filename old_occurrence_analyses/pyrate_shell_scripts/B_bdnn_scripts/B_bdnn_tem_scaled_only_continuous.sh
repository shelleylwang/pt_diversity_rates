#!/bin/bash
#SBATCH --job-name=B_bdnn_tem_stdscaled_only_continuous         # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/B_bdnn_tem_stdscaled_only_continuous_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/B_bdnn_tem_stdscaled_only_continuous_%j_%A_%a.err
...
-wd ./temnospondyli/ -out _B_stdscaled_only_continuous -j ${SLURM_ARRAY_TASK_ID}
