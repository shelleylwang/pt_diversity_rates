#!/bin/bash
#SBATCH --job-name=B_bdnn_tem_stdscaled_log_cbrt_rerestorations_again        # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/B_bdnn_tem_stdscaled_log_cbrt_rerestorations_again_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/B_bdnn_tem_stdscaled_log_cbrt_rerestorations_again_%j_%A_%a.err
...
-restore_mcmc ./temnospondyli/mcmc_predictors/B_bdnn_stdscaled_log/temnospondyli_pyrate_4_B_stdscaled_log_G_BDS_BDNN_16_8TVc_mcmc_CONCAT.log \
...
-wd ./temnospondyli/mcmc_predictors/B_bdnn_stdscaled_log/ -out _B_stdscaled_log_rerestorations_again -j 4 &

python ../PyRate/PyRate.py ./data/temnospondyli_processed_data/temnospondyli_pyrate_PyRate.py -BDNNmodel 1 \
-restore_mcmc ./temnospondyli/mcmc_predictors/B_bdnn_stdscaled_log/temnospondyli_pyrate_8_B_stdscaled_log_G_BDS_BDNN_16_8TVc_mcmc_CONCAT.log \
-qShift ./data/Time_bins_ByStages.txt -mG -translate -175.0 \
-trait_file ./data/temnospondyli_processed_data/temnospondyli_bdnn_trait_file.txt -BDNNtimevar ./data/1myr_temp_data/1myr_temp_scaled_log.txt \
-n 90000000 -s 10000 -p 2000 -seed 42 \
-wd ./temnospondyli/mcmc_predictors/B_bdnn_stdscaled_log/ -out _B_stdscaled_log_rerestorations_again -j 8 &
