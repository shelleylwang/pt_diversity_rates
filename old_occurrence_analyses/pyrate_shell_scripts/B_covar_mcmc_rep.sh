#!/bin/bash
#SBATCH --job-name=B_covar_mcmc_rep          # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/B_covar_mcmc_rep_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/B_covar_mcmc_rep_%j_%A_%a.err
