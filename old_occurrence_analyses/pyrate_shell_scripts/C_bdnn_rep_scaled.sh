#!/bin/bash
#SBATCH --job-name=C_bdnn_rep_scaled         # Job name
...
#SBATCH --output=/scratch/gpfs/sw8569/C_bdnn_rep_scaled_%j_%A_%a.out
#SBATCH --error=/scratch/gpfs/sw8569/C_bdnn_rep_scaled_%j_%A_%a.err
