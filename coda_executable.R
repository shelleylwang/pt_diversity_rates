...
analyze_mcmc <- function(working_dir, file_name) {
  ...
  pdf_file <- past0(output_file, "mcmc_diagnostics_plots.pdf")
...
# Example usage:
# results <- analyze_mcmc("reptilia/mcmc_no_predictors/A_rjmcmc_sampled_every_10k", 
#                        "reptilia_pyrate_1_A_rjmcmc_Grj_mcmc.log")
